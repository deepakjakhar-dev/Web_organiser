  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/register`, {
        ...
        body: JSON.stringify({ email, password, website_url: "" }),
      });
  ...
  return (
    <div className={styles.container}>
      <div className="card" style={{ maxWidth: "450px", width: "100%" }}>
        <h1 style={{ textAlign: "center", marginBottom: "1rem" }}>Create your Sitewell account</h1>
        <p style={{ textAlign: "center", color: "var(--text-muted)", marginBottom: "2rem" }}>
          Start free and unlock Pro whenever you need deeper reporting.
        </p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="strength-meter">
            <div className="strength-bar" style={{ width: `${strength}%`, backgroundColor: getStrengthColor() }}></div>
          </div>
